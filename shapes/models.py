...
class BeadShape(models.Model):
    ...
    is_default = models.BooleanField(default=False, verbose_name=_("Forme par défaut"))
    is_shared = models.BooleanField(default=False, verbose_name=_("Forme partagée"))

    class Meta:
        verbose_name = _("Forme de perles")
        verbose_name_plural = _("Formes de perles")
        ordering = ["name"]
