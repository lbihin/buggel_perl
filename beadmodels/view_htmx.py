...
def bead_edit_quantity_htmx(request, pk):
    ...
    return render(
        request, "beadmodels/beads/htmx/bead_edit_quantity.html", {"bead": bead}
    )
...
def bead_edit_color_htmx(request, pk):
    ...
    if request.GET.get("cancel"):
        return render(
            request, "beadmodels/beads/htmx/bead_color_display.html", {"bead": bead}
        )
    return render(request, "beadmodels/beads/htmx/bead_edit_color.html", {"bead": bead})
...
def bead_update_color_htmx(request, pk):
    ...
    if request.method == "POST":
        try:
            ...
            return render(
                request,
                "beadmodels/beads/htmx/bead_edit_color.html",
                {
                    "bead": bead,
