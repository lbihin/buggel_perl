const shapeData = JSON.parse(document.getElementById('shapeForm').dataset.shapeParameters);
...
function updateShapeControls() {
    ...
    switch (shapeType) {
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="width" min="1" value="${shapeData.width || 10}" onchange="updatePreview()">
        </div>
        <div class="mb-3">
          <label class="form-label">Hauteur (pics)</label>
          <input type="number" class="form-control" id="height" min="1" value="${shapeData.height || 8}" onchange="updatePreview()">
        </div>
      `;
            break;
        case 'square':
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="size" min="1" value="${shapeData.size || 10}" onchange="updatePreview()">
        </div>
      `;
            break;
        case 'circle':
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="diameter" min="1" value="${shapeData.diameter || 10}" onchange="updatePreview()">
        </div>
      `;
            break;
    }
...
function saveShape() {
    ...
    fetch(`{% url 'beadmodels:edit_shape' shape.id %}`, {
        method: 'POST',
        headers: {
